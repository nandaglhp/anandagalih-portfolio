        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              Certified Data Analyst. Experienced in data analysis through 1 year of hands-on involvement in internships and real-world projects. As a Data Analyst, I manage the end-to-end process of transforming raw data into actionable
              insights — from data collection, cleaning, and validation to analysis, visualization, and reporting. Proficient in statistical methods, SQL, Python, Excel, and data visualization tools. Skilled in validating data accuracy,
              identifying trends, and creating clear reports to support decision-making. I see data integrity and meaningful storytelling as the foundation for reliable, scalable, and impactful solutions.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">"Empowering business decisions through data-driven insights."</blockquote>
            </div>

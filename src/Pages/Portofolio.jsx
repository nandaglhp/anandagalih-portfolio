...
export default function FullWidthTabs() {
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#3a2a31] overflow-hidden text-white relative" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-rose-400">
          <span
            style={{
              color: "#ec4899",
              backgroundImage: "linear-gradient(45deg, #ec4899 10%, #f472b6 93%)",
        ...
        <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base mt-2">Explore my journey through projects, certifications, and technical expertise. Each section represents a milestone in my continuous learning path.</p>
      </div>
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              right: 0,
              bottom: 0,
              background: "linear-gradient(180deg, rgba(236,72,153,0.05) 0%, rgba(244,114,182,0.05) 100%)",
            ...
            sx={{
              ...
              "& .MuiTab-root": {
                ...
                "&.Mui-selected": {
                  ...
                  boxShadow: "0 4px 15px -3px rgba(236,72,153,0.25)",
                  "& .lucide": {
                    color: "#f9a8d4",
                  },
                },

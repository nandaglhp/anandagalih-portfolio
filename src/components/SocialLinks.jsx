...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ANANDA GALIH/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ANANDA GALIH_",
    icon: Instagram,
    url: "https://www.instagram.com/ANANDA GALIH_/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Ananda Galih",
    icon: Youtube,
    url: "https://www.youtube.com/@Ananda Galih",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@ANANDA GALIH",
    icon: Github,
    url: "https://github.com/ANANDA GALIH",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-pink-50/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3 className="text-xl font-semibold text-white mb-6 flex items-center gap-2" data-aos="fade-down">
        <span className="inline-block w-8 h-1 bg-pink-400 rounded-full"></span>
        Connect With Me
      </h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-lg 
                   ...
                   hover:border-pink-200/40 transition-all duration-500"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          ...
          <div
            className={`absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500
                     bg-gradient-to-r from-pink-300/40 to-rose-400/30`}
          />
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="relative flex items-center justify-center">
              <div
                ...
                style={{ backgroundColor: "#f9a8d4" }} // soft pink
              />
              <div className="relative p-2 rounded-md">
                <linkedIn.icon className="w-6 h-6 transition-all duration-500 group-hover:scale-105" style={{ color: "#f472b6" }} />
              </div>
            </div>

            {/* Text Container */}
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-gray-100 tracking-tight leading-none group-hover:text-white transition-colors duration-300">{linkedIn.displayName}</span>
              <span className="text-sm text-gray-400 group-hover:text-pink-100 transition-colors duration-300">{linkedIn.subText}</span>
            </div>
          </div>

          <ExternalLink
            className="relative w-5 h-5 text-gray-400 group-hover:text-pink-100
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, youtube].map((link, index) => (
            ...
            >
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500
                                   bg-gradient-to-r from-pink-300/30 to-rose-400/30`}
              />
              ...
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative p-2 rounded-lg">
                  <link.icon className="w-5 h-5 transition-all duration-500 group-hover:scale-110" style={{ color: "#f472b6" }} />
                </div>
              </div>

              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold text-gray-100 group-hover:text-white transition-colors duration-300">{link.displayName}</span>
                <span className="text-xs text-gray-400 truncate group-hover:text-pink-100 transition-colors duration-300">{link.subText}</span>
              </div>

              <ExternalLink
                className="w-4 h-4 text-gray-400 group-hover:text-pink-100 ml-auto
                                   opacity-0 group-hover:opacity-100 transition-all duration-300
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, tiktok].map((link, index) => (
            ...
            >
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500
                                   bg-gradient-to-r from-rose-300/30 to-fuchsia-400/30`}
              />
